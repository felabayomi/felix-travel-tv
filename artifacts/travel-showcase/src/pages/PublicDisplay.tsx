      ...
      <div className="fixed bottom-16 right-4 z-50">
        {isRecording ? (
          <button
            ...
            style={{ background: 'rgba(200,16,46,0.9)', backdropFilter: 'blur(8px)' }}
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-full text-white text-xs font-semibold shadow-lg opacity-30 hover:opacity-90 transition-opacity"
