...
function AdminDashboard() {
  ...
  const loadQueue = useCallback(async () => {
    try {
      ...
      // Keep last known-good playback state on transient poll failures.
      // Overwriting with empty/default state causes clip rewinds and stale voice callbacks.
      console.warn('[queue] load failed; preserving current playback state', err);
    }
  }, []);
